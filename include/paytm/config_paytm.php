 <?php
	...
	define('CHANNEL_ID', 'WEB'); //Change this constant's value with Website channel id given by Paytm.
	define('CALLBACK_URL', 'http://localhost/holiday_inn/pay_response.php');
