<?php 
    ...
    define('SITE_URL','http://127.0.0.1/CHARMING-NEST/');
    ...
    define('UPLOAD_IMAGE_PATH',$_SERVER['DOCUMENT_ROOT'].'/CHARMING-NEST/images/');
    ...
    //Possile "booking status" values in db = pending, booked, payment failed, cancelled
