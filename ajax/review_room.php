<?php 
    ...
    if(isset($_POST['review_form']))
    {
        ...
        $upd_query = "UPDATE `booking_order` SET `booking_status`=?, `refund`=?
        ...
        $ins_values = [$frm_data['booking_id'],$frm_data['room_id'],$frm_data['user_id'],$frm_data['rating'],$frm_data['review']];
